            ...
            <div className={`relative h-[91vh] md:h-screen flex items-center flex-col overflow-hidden ${isDev && devBorder}`}>
                ...
                {!chosenScheduleData &&
                    <div className='w-full flex items-center justify-end flex-col overflow-y-hidden sm:px-3'>
                        <div className={`relative top-10 sm:-top-9 w-full sm:w-fit h-screen min-[480px]:h-[85%] flex items-center justify-center flex-col rounded-lg overflow-hidden mb-1 ${isDev && devBorder}`}>
