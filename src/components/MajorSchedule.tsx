                                    ...
                                    <div className='flex items-center gap-2 md:text-xl pt-1 sm:pt-0'>
                                        ...
                                        <ul className='flex gap-2'>
                                            <li
                                                ...
                                                className={`${yearSelectionEl} ${interStyles} ${selectedYear == null && "bg-gray-900 dark:bg-red-500 text-white dark:text-black"} ${colorsSmooth}`}>
                                                Wszysktie
                                            </li>
                                            {majorYears.map((year, index) => (
                                                <li
                                                    ...
                                                    key={index}
                                                    className={`${yearSelectionEl} ${interStyles} ${selectedYear == year && "bg-gray-900 dark:bg-red-500 text-white dark:text-black"} ${colorsSmooth}`}>
                                                    {year}
                                                </li>
                                            ))}
                                        </ul>
