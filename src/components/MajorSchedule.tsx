// Todo: Kompletna zmiana ułożenia ui main ma być na 100vh i najlepiej jakby padał cień spod Cofnij
...
function MajorSchedule({ firstTryFetchingData, returnToMenu }: MajorScheduleProps) {
    ...
    return (
        <>
            ...
            <div className={`max-[480px]:h-screen min-[480px]:h-[94vh] flex items-center flex-col overflow-hidden`}>
