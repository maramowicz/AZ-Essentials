...
function DynamicSearch({ returnToMenu, searchType, firstTryFetchingData }: {
    ...
    const optionsStyle = "md:w-72 dark:md:bg-red-500 lg:w-[25rem] text-3xl md:text-[36px] lg:text-5xl px-2 py-1 md:text-lg text-black dark:text-white bg-white dark:bg-gray-900 shadow-md shadow-gray-400 disabled:shadow-black dark:shadow-[1px_2px_5px_1px_rgb(10,10,10)] rounded-md outline-none focus:border-gray-900 dark:focus:border-gray-400 border-2 border-transparent hover:scale-[1.05] transition-all duration-150 cursor-pointer disabled:cursor-not-allowed disabled:opacity-25";
