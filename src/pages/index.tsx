  ...
  function formatResult() {
    ...
    return (
      <div className="h-[93vh] flex items-center justify-center">
        <ul className={`relative -top-3 sm:top-0 h-3/4 border flex items-center justify-center flex-col gap-2 overflow-y-auto overflow-x-hidden px-1.5 pb-1.5 custom-scrollbar`} style={{ paddingTop }}>
